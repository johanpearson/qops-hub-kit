 ...
 */
export function getOrCreateCorrelationId(request: HttpRequest, context: InvocationContext): string {
 ...
 */
export function addCorrelationIdToContext(context: InvocationContext, correlationId: string): void {
